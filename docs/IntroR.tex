...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Dados}\OperatorTok{$}\NormalTok{Regiao}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nossalista}\OperatorTok{$}\NormalTok{Ilha}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nossalista}\OperatorTok{$}\NormalTok{Localizacao}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{elv_cat <-}\StringTok{ }\KeywordTok{cut}\NormalTok{(dbenv}\OperatorTok{$}\NormalTok{alt, }\DataTypeTok{breaks =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{300}\NormalTok{, }\DecValTok{600}\NormalTok{, }\DecValTok{1000}\NormalTok{), }
              \DataTypeTok{labels =} \KeywordTok{c}\NormalTok{(}\StringTok{"Baixo"}\NormalTok{, }\StringTok{"Medio"}\NormalTok{, }\StringTok{"Alto"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dbenv}\OperatorTok{$}\NormalTok{trecho <-}\StringTok{ }\NormalTok{elv_cat}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dbenv <-}\StringTok{ }\KeywordTok{transform}\NormalTok{(dbenv,  }
 \DataTypeTok{saturacao =} \KeywordTok{cut}\NormalTok{(dbenv}\OperatorTok{$}\NormalTok{oxy, }\DataTypeTok{breaks =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{40}\NormalTok{, }\DecValTok{109}\NormalTok{, }\DecValTok{124}\NormalTok{), }
           \DataTypeTok{labels =} \KeywordTok{c}\NormalTok{(}\StringTok{"Pobre"}\NormalTok{, }\StringTok{"Medio"}\NormalTok{, }\StringTok{"Saturado"}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{mean}\NormalTok{(dbenv}\OperatorTok{$}\NormalTok{pH)  }\CommentTok{# média aritmética}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{tapply}\NormalTok{(dbenv}\OperatorTok{$}\NormalTok{pH, dbenv}\OperatorTok{$}\NormalTok{trecho, mean)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{tapply}\NormalTok{(dbenv}\OperatorTok{$}\NormalTok{pH, dbenv}\OperatorTok{$}\NormalTok{trecho, range)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{media.trecho <-}\StringTok{ }\KeywordTok{aggregate}\NormalTok{(dbenv[, }\DecValTok{1}\OperatorTok{:}\DecValTok{11}\NormalTok{], }
                         \DataTypeTok{by =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{TRECHO =}\NormalTok{ dbenv}\OperatorTok{$}\NormalTok{trecho,}
                                   \DataTypeTok{ALCALINO =}\NormalTok{ dbenv}\OperatorTok{$}\NormalTok{pH }\OperatorTok{>=}\StringTok{ }\DecValTok{80}\NormalTok{),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ambiente <-}\StringTok{ }\NormalTok{doubs}\OperatorTok{$}\NormalTok{env}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ambiente}\OperatorTok{$}\NormalTok{secao <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\KeywordTok{rep}\NormalTok{(}\StringTok{"Seção 1"}\NormalTok{, }\DecValTok{16}\NormalTok{), }\KeywordTok{rep}\NormalTok{(}\StringTok{"Seção 4"}\NormalTok{, }\DecValTok{14}\NormalTok{))}
\NormalTok{ambiente}\OperatorTok{$}\NormalTok{secao[}\KeywordTok{c}\NormalTok{(}\DecValTok{5}\NormalTok{,}\DecValTok{9}\NormalTok{,}\DecValTok{17}\NormalTok{)] <-}\StringTok{ "Seção 2"}
\NormalTok{ambiente}\OperatorTok{$}\NormalTok{secao[}\DecValTok{23}\OperatorTok{:}\DecValTok{25}\NormalTok{] <-}\StringTok{ "Seção 3"}
\NormalTok{ambiente}\OperatorTok{$}\NormalTok{secao <-}\StringTok{ }\KeywordTok{factor}\NormalTok{(ambiente}\OperatorTok{$}\NormalTok{secao)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ambiente}\OperatorTok{$}\NormalTok{trofia <-}\StringTok{ }\KeywordTok{cut}\NormalTok{(ambiente}\OperatorTok{$}\NormalTok{oxy, }\DataTypeTok{breaks =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{80}\NormalTok{, }\DecValTok{109}\NormalTok{, }\DecValTok{124}\NormalTok{), }
           \DataTypeTok{labels =} \KeywordTok{c}\NormalTok{(}\StringTok{"Pobre"}\NormalTok{, }\StringTok{"Médio"}\NormalTok{, }\StringTok{"Saturado"}\NormalTok{))}
\KeywordTok{head}\NormalTok{(ambiente, }\DecValTok{10}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tab1 <-}\StringTok{ }\KeywordTok{table}\NormalTok{(ambiente}\OperatorTok{$}\NormalTok{trofia)}
\NormalTok{tab1}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{hist}\NormalTok{(ambiente}\OperatorTok{$}\NormalTok{oxy)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ambiente[}\KeywordTok{order}\NormalTok{(ambiente}\OperatorTok{$}\NormalTok{oxy),]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{classes <-}\StringTok{ }\KeywordTok{seq}\NormalTok{(}\DecValTok{40}\NormalTok{, }\DecValTok{140}\NormalTok{, }\DataTypeTok{by =} \DecValTok{20}\NormalTok{)}
\KeywordTok{hist}\NormalTok{(ambiente}\OperatorTok{$}\NormalTok{oxy, }\DataTypeTok{breaks =}\NormalTok{ classes)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{boxplot}\NormalTok{(ambiente}\OperatorTok{$}\NormalTok{oxy)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{quantile}\NormalTok{(ambiente}\OperatorTok{$}\NormalTok{oxy, }\DataTypeTok{probs =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FloatTok{0.25}\NormalTok{, }\FloatTok{0.5}\NormalTok{, }\FloatTok{0.75}\NormalTok{, }\DecValTok{1}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ doubs}\OperatorTok{$}\NormalTok{xy}\OperatorTok{$}\NormalTok{x, }\DataTypeTok{y =}\NormalTok{ doubs}\OperatorTok{$}\NormalTok{xy}\OperatorTok{$}\NormalTok{y, }\DataTypeTok{type =} \StringTok{"l"}\NormalTok{,}
     \DataTypeTok{xlab =} \StringTok{"Coordenada em x (km)"}\NormalTok{, }
     \DataTypeTok{ylab =} \StringTok{"Coordenada em y (km)"}\NormalTok{,}
     \DataTypeTok{col =} \StringTok{"#4287f5"}\NormalTok{, }\DataTypeTok{lwd =} \DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pontos_extremos <-}\StringTok{ }\NormalTok{doubs}\OperatorTok{$}\NormalTok{xy[}\KeywordTok{which}\NormalTok{(doubs}\OperatorTok{$}\NormalTok{env}\OperatorTok{$}\NormalTok{dfs }\OperatorTok{==}\StringTok{ }\KeywordTok{min}\NormalTok{(doubs}\OperatorTok{$}\NormalTok{env}\OperatorTok{$}\NormalTok{dfs) }\OperatorTok{|}\StringTok{ }
\StringTok{                                      }\NormalTok{doubs}\OperatorTok{$}\NormalTok{env}\OperatorTok{$}\NormalTok{dfs }\OperatorTok{==}\StringTok{ }\KeywordTok{max}\NormalTok{(doubs}\OperatorTok{$}\NormalTok{env}\OperatorTok{$}\NormalTok{dfs)),]}
\KeywordTok{plot}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ doubs}\OperatorTok{$}\NormalTok{xy}\OperatorTok{$}\NormalTok{x, }\DataTypeTok{y =}\NormalTok{ doubs}\OperatorTok{$}\NormalTok{xy}\OperatorTok{$}\NormalTok{y, }\DataTypeTok{type =} \StringTok{"l"}\NormalTok{,}
     \DataTypeTok{xlab =} \StringTok{"Coordenada em x (km)"}\NormalTok{, }
     \DataTypeTok{ylab =} \StringTok{"Coordenada em y (km)"}\NormalTok{,}
     \DataTypeTok{col =} \StringTok{"#4287f5"}\NormalTok{, }\DataTypeTok{lwd =} \DecValTok{3}\NormalTok{)}
\KeywordTok{text}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ pontos_extremos}\OperatorTok{$}\NormalTok{x, }
       \DataTypeTok{y =}\NormalTok{ pontos_extremos}\OperatorTok{$}\NormalTok{y,}
       \DataTypeTok{labels =} \KeywordTok{c}\NormalTok{(}\StringTok{"Cabeceira"}\NormalTok{, }\StringTok{"Foz"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{secao_cor <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(ambiente}\OperatorTok{$}\NormalTok{secao)}

\KeywordTok{plot}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ doubs}\OperatorTok{$}\NormalTok{xy}\OperatorTok{$}\NormalTok{x, }\DataTypeTok{y =}\NormalTok{ doubs}\OperatorTok{$}\NormalTok{xy}\OperatorTok{$}\NormalTok{y, }\DataTypeTok{type =} \StringTok{"l"}\NormalTok{,}
     \DataTypeTok{xlab =} \StringTok{"Coordenada em x (km)"}\NormalTok{, }
     \DataTypeTok{ylab =} \StringTok{"Coordenada em y (km)"}\NormalTok{,}
     \DataTypeTok{col =} \StringTok{"#4287f5"}\NormalTok{, }\DataTypeTok{lwd =} \DecValTok{3}\NormalTok{)}
\KeywordTok{points}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ doubs}\OperatorTok{$}\NormalTok{xy}\OperatorTok{$}\NormalTok{x, }\DataTypeTok{y =}\NormalTok{ doubs}\OperatorTok{$}\NormalTok{xy}\OperatorTok{$}\NormalTok{y, }\DataTypeTok{pch =} \DecValTok{21}\NormalTok{, }
       \DataTypeTok{bg =}\NormalTok{ secao_cor, }\DataTypeTok{cex =} \DecValTok{3}\NormalTok{)}
\KeywordTok{legend}\NormalTok{(}\DataTypeTok{x =} \StringTok{"bottomright"}\NormalTok{, }\DataTypeTok{col =} \DecValTok{1}\OperatorTok{:}\DecValTok{4}\NormalTok{, }
       \DataTypeTok{legend =} \KeywordTok{levels}\NormalTok{(ambiente}\OperatorTok{$}\NormalTok{secao), }\DataTypeTok{bty =} \StringTok{"n"}\NormalTok{, }\DataTypeTok{pch =} \DecValTok{19}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{secao_cor <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(ambiente}\OperatorTok{$}\NormalTok{secao) }\OperatorTok{+}\StringTok{ }\DecValTok{1}
...
\KeywordTok{plot}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ doubs}\OperatorTok{$}\NormalTok{xy}\OperatorTok{$}\NormalTok{x, }\DataTypeTok{y =}\NormalTok{ doubs}\OperatorTok{$}\NormalTok{xy}\OperatorTok{$}\NormalTok{y, }\DataTypeTok{type =} \StringTok{"l"}\NormalTok{,}
     ...
     \DataTypeTok{col =} \StringTok{"#4287f5"}\NormalTok{, }\DataTypeTok{lwd =} \DecValTok{3}\NormalTok{)}
\KeywordTok{points}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ doubs}\OperatorTok{$}\NormalTok{xy}\OperatorTok{$}\NormalTok{x, }\DataTypeTok{y =}\NormalTok{ doubs}\OperatorTok{$}\NormalTok{xy}\OperatorTok{$}\NormalTok{y, }\DataTypeTok{pch =} \DecValTok{21}\NormalTok{, }
       \DataTypeTok{bg =}\NormalTok{ secao_cor, }\DataTypeTok{cex =} \DecValTok{4}\NormalTok{)}
\KeywordTok{legend}\NormalTok{(}\DataTypeTok{x =} \StringTok{"bottomright"}\NormalTok{, }\DataTypeTok{col =} \DecValTok{1}\OperatorTok{:}\DecValTok{4}\NormalTok{, }
       \DataTypeTok{legend =} \KeywordTok{levels}\NormalTok{(ambiente}\OperatorTok{$}\NormalTok{secao), }\DataTypeTok{bty =} \StringTok{"n"}\NormalTok{, }\DataTypeTok{pch =} \DecValTok{19}\NormalTok{)}
\KeywordTok{text}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ doubs}\OperatorTok{$}\NormalTok{xy}\OperatorTok{$}\NormalTok{x, }\DataTypeTok{y =}\NormalTok{ doubs}\OperatorTok{$}\NormalTok{xy}\OperatorTok{$}\NormalTok{y, }\DataTypeTok{labels =}\NormalTok{ doubs}\OperatorTok{$}\NormalTok{env}\OperatorTok{$}\NormalTok{amm, }
     \DataTypeTok{cex =} \FloatTok{0.8}\NormalTok{, }\DataTypeTok{font =} \DecValTok{2}\NormalTok{)}
\KeywordTok{text}\NormalTok{(}\DataTypeTok{x =} \DecValTok{55}\NormalTok{, }\DataTypeTok{y =} \DecValTok{220}\NormalTok{, }\DataTypeTok{labels =} \StringTok{"Concentração de amônia"}\NormalTok{)}
\KeywordTok{text}\NormalTok{(}\DataTypeTok{x =} \DecValTok{25}\NormalTok{, }\DataTypeTok{y =} \DecValTok{120}\NormalTok{, }\DataTypeTok{label =} \StringTok{"Foz"}\NormalTok{)}
\KeywordTok{text}\NormalTok{(}\DataTypeTok{x =} \DecValTok{60}\NormalTok{, }\DataTypeTok{y =} \DecValTok{20}\NormalTok{, }\DataTypeTok{label =} \StringTok{"Cabeceira"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{variavel }\OperatorTok{%>%}\StringTok{ }\KeywordTok{sqrt}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{objeto }\OperatorTok{%>%}\StringTok{ }\KeywordTok{sqrt}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }\KeywordTok{round}\NormalTok{(}\DataTypeTok{digits =} \DecValTok{2}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{diff}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }\KeywordTok{sum}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{iris }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{arrange}\NormalTok{(}\KeywordTok{desc}\NormalTok{(Sepal.Length))}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{iris }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{arrange}\NormalTok{(}\KeywordTok{desc}\NormalTok{(Species), Sepal.Length)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{iris_ordenado <-}\StringTok{ }\NormalTok{iris }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{arrange}\NormalTok{(Sepal.Length)}

\NormalTok{iris_ordenado}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{iris }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(Petal.Length }\OperatorTok{<}\StringTok{ }\FloatTok{1.3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{iris }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(Petal.Length }\OperatorTok{<}\StringTok{ }\FloatTok{1.3} \OperatorTok{&}\StringTok{ }\NormalTok{Sepal.Length }\OperatorTok{>=}\StringTok{ }\DecValTok{5}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{iris }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(Petal.Length)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{iris }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(Petal.Length, Species)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{iris }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(Petal.Length}\OperatorTok{:}\NormalTok{Species)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{iris }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(Species}\OperatorTok{:}\NormalTok{Petal.Length)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{iris }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(}\OperatorTok{!}\KeywordTok{c}\NormalTok{(Petal.Length, Species))}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(Sepal.Length }\OperatorTok{<=}\StringTok{ }\FloatTok{4.5}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{regiao }\OperatorTok{%>%}\StringTok{ }\KeywordTok{left_join}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ habitat)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{regiao }\OperatorTok{%>%}\StringTok{ }\KeywordTok{right_join}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ habitat)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{regiao }\OperatorTok{%>%}\StringTok{ }\KeywordTok{inner_join}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ habitat)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{regiao }\OperatorTok{%>%}\StringTok{ }\KeywordTok{anti_join}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ habitat)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{habitat }\OperatorTok{%>%}\StringTok{ }\KeywordTok{anti_join}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ regiao)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{regiao }\OperatorTok{%>%}\StringTok{ }\KeywordTok{full_join}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ habitat)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{habitat }\OperatorTok{%>%}\StringTok{ }\KeywordTok{semi_join}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ regiao)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{data}\NormalTok{(doubs)}
\NormalTok{ambiente <-}\StringTok{ }\NormalTok{doubs}\OperatorTok{$}\NormalTok{env}
\KeywordTok{head}\NormalTok{(ambiente)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ambiente }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{pH =}\NormalTok{ pH}\OperatorTok{/}\DecValTok{10}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{ambiente }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{pH =}\NormalTok{ pH}\OperatorTok{/}\DecValTok{10}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{pH_cat =} \KeywordTok{ifelse}\NormalTok{(pH }\OperatorTok{<}\StringTok{ }\DecValTok{8}\NormalTok{, }\DataTypeTok{yes =} \StringTok{"Neutro"}\NormalTok{, }\DataTypeTok{no =} \StringTok{"Elevado"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ambiente }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{pH =}\NormalTok{ pH}\OperatorTok{/}\DecValTok{10}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{pH_cat =} \KeywordTok{ifelse}\NormalTok{(pH }\OperatorTok{<}\StringTok{ }\DecValTok{8}\NormalTok{, }\DataTypeTok{yes =} \StringTok{"Neutro"}\NormalTok{, }\DataTypeTok{no =} \StringTok{"Elevado"}\NormalTok{), }\DataTypeTok{.after =}\NormalTok{ pH)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{iris2 <-}\StringTok{ }\NormalTok{iris }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(Sepal.Length }\OperatorTok{>}\StringTok{ }\FloatTok{5.5} \OperatorTok{&}\StringTok{ }\NormalTok{Sepal.Length }\OperatorTok{<}\StringTok{ }\FloatTok{6.1}\NormalTok{)}
\NormalTok{iris2}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Genus =} \KeywordTok{rep}\NormalTok{(}\StringTok{"Iris"}\NormalTok{, }\DataTypeTok{times =} \KeywordTok{nrow}\NormalTok{(iris2)), }\DataTypeTok{.before =}\NormalTok{ Species)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{iris3 <-}\StringTok{ }\NormalTok{iris2 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Genus =} \KeywordTok{rep}\NormalTok{(}\StringTok{"Iris"}\NormalTok{, }\DataTypeTok{times =} \KeywordTok{nrow}\NormalTok{(iris2)), }\DataTypeTok{.before =}\NormalTok{ Species) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{unite}\NormalTok{(}\DataTypeTok{col =}\NormalTok{ scientic_name, Genus, Species, }\DataTypeTok{sep =} \StringTok{" "}\NormalTok{)}
\NormalTok{iris3}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{stream_largo <-}\StringTok{ }\NormalTok{stream }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{Precipitation) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{spread}\NormalTok{(}\DataTypeTok{key =}\NormalTok{ Treatment, }\DataTypeTok{value =}\NormalTok{ Flow)}
\NormalTok{stream_largo}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{stream_longo <-}\StringTok{ }\NormalTok{stream_largo }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{gather}\NormalTok{(}\DataTypeTok{key =}\NormalTok{ Desmatamento, }\DataTypeTok{value =}\NormalTok{ Flow, }\OperatorTok{-}\NormalTok{Year)}
\NormalTok{stream_longo}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{hub }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(Treatment }\OperatorTok{==}\StringTok{ "Deforested"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{mapping =} \KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ Year, }\DataTypeTok{y =}\NormalTok{ Flow)) }\OperatorTok{+}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{extremo <-}\StringTok{ }\DecValTok{1000}

\NormalTok{hub }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Vazao_cat =} \KeywordTok{ifelse}\NormalTok{(Flow }\OperatorTok{>=}\StringTok{ }\NormalTok{extremo, }
                            \DataTypeTok{yes =} \StringTok{"Extrema"}\NormalTok{, }
                            \DataTypeTok{no =} \StringTok{"Normal"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{mapping =} \KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ Vazao_cat)) }\OperatorTok{+}
...
\begin{Highlighting}[]
\NormalTok{hub }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Vazao_cat =} \KeywordTok{ifelse}\NormalTok{(Flow }\OperatorTok{>=}\StringTok{ }\NormalTok{extremo, }\DataTypeTok{yes =} \StringTok{"Extrema"}\NormalTok{, }\DataTypeTok{no =} \StringTok{"Normal"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{mapping =} \KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ Vazao_cat)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_bar}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
